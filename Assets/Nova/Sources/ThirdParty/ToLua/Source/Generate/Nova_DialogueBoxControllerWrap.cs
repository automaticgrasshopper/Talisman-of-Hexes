...
public class Nova_DialogueBoxControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("AbortTextAnimationDelay", AbortTextAnimationDelay);
		L.RegFunction("SetTextAnimationDelay", SetTextAnimationDelay);
		L.RegFunction("OverrideTextDuration", OverrideTextDuration);
		L.RegFunction("OverrideTextEasing", OverrideTextEasing);
		...
		L.RegFunction("Forward", Forward);
		L.RegFunction("GetPageCharacterCount", GetPageCharacterCount);
		...
		L.RegVar("textAnimationDelay", get_textAnimationDelay, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int AbortTextAnimationDelay(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.DialogueBoxController obj = (Nova.DialogueBoxController)ToLua.CheckObject<Nova.DialogueBoxController>(L, 1);
			obj.AbortTextAnimationDelay();
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int OverrideTextEasing(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetPageCharacterCount(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.DialogueBoxController obj = (Nova.DialogueBoxController)ToLua.CheckObject<Nova.DialogueBoxController>(L, 1);
			int o = obj.GetPageCharacterCount();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_textAnimationDelay(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.DialogueBoxController obj = (Nova.DialogueBoxController)o;
			float ret = obj.textAnimationDelay;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index textAnimationDelay on a nil value");
		}
	}
