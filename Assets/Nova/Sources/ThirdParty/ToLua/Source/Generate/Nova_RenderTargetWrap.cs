...
public class Nova_RenderTargetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("textureDepth", get_textureDepth, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_textureDepth(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.RenderTarget obj = (Nova.RenderTarget)o;
			int ret = obj.textureDepth;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index textureDepth on a nil value");
		}
	}
