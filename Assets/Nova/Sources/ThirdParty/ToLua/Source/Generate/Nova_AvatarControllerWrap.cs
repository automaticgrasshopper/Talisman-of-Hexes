...
public class Nova_AvatarControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("imageFolder", get_imageFolder, null);
	...
	static int ClearImageDelayed(IntPtr L)
	{
		try
		{
			...
			else if (count == 2)
			{
				Nova.AvatarController obj = (Nova.AvatarController)ToLua.CheckObject<Nova.AvatarController>(L, 1);
				string arg0 = ToLua.CheckString(L, 2);
				obj.ClearImageDelayed(arg0);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Nova.AvatarController.ClearImageDelayed");
			}
		}
		catch (Exception e)
		{
	...
	static int SetPose(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				obj.SetPose(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Nova.AvatarController.SetPose");
			}
		}
		catch (Exception e)
		{
	...
	static int get_characterName(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index characterName on a nil value");
		}
	}
