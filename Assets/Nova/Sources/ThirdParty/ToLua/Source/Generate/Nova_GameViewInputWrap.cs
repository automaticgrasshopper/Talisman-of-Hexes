...
public class Nova_GameViewInputWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetClickSoundVolume", SetClickSoundVolume);
		L.RegFunction("GetClickSoundVolume", GetClickSoundVolume);
	...
	static int SetClickSoundVolume(IntPtr L)
	{
		try
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetClickSoundVolume(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.GameViewInput obj = (Nova.GameViewInput)ToLua.CheckObject<Nova.GameViewInput>(L, 1);
			float o = obj.GetClickSoundVolume();
