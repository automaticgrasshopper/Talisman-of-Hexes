...
public class Nova_ScriptLoaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetChunkHash", GetChunkHash);
		...
		L.RegFunction("SetCurrentAsSavePoint", SetCurrentAsSavePoint);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetChunkHash(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			System.Collections.Generic.IReadOnlyList<Nova.Parser.ParsedBlock> arg0 = (System.Collections.Generic.IReadOnlyList<Nova.Parser.ParsedBlock>)ToLua.CheckObject<System.Collections.Generic.IReadOnlyList<Nova.Parser.ParsedBlock>>(L, 1);
			ulong o = Nova.ScriptLoader.GetChunkHash(arg0);
	...
	static int AddDeferredDialogueChunks(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.FlowChartNode arg0 = (Nova.FlowChartNode)ToLua.CheckObject<Nova.FlowChartNode>(L, 1);
			Nova.ScriptLoader.AddDeferredDialogueChunks(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int RegisterBranch(IntPtr L)
	{
		try
		{
			...
			Nova.ChoiceImageInformation arg3 = (Nova.ChoiceImageInformation)ToLua.CheckObject<Nova.ChoiceImageInformation>(L, 5);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetCurrentAsSavePoint(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.ScriptLoader obj = (Nova.ScriptLoader)ToLua.CheckObject<Nova.ScriptLoader>(L, 1);
			obj.SetCurrentAsSavePoint();
			return 0;
		}
		catch (Exception e)
		{
