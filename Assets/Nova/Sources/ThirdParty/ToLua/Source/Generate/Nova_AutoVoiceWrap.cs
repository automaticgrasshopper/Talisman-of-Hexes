...
public class Nova_AutoVoiceWrap
{
	...
	static int GetCharacterController(IntPtr L)
	{
		try
		{
			...
			Nova.GameCharacterController o = obj.GetCharacterController(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DisableAll(IntPtr L)
	{
		try
		{
