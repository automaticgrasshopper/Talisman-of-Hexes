...
public class Nova_ActionAnimationPropertyWrap
{
	...
	{
		L.BeginClass(typeof(Nova.ActionAnimationProperty), typeof(Nova.AnimationProperty));
	...
	static int Dispose(IntPtr L)
	{
		try
		{
			...
			Nova.ActionAnimationProperty obj = (Nova.ActionAnimationProperty)ToLua.CheckObject<Nova.ActionAnimationProperty>(L, 1);
			obj.Dispose();
			return 0;
		}
		catch (Exception e)
