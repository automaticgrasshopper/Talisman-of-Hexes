...
public class Nova_GameViewControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("OverrideAutoTime", OverrideAutoTime);
		L.RegFunction("ScheduleImmediateStep", ScheduleImmediateStep);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int OverrideAutoTime(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ScheduleImmediateStep(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Nova.GameViewController obj = (Nova.GameViewController)ToLua.CheckObject<Nova.GameViewController>(L, 1);
			obj.ScheduleImmediateStep();
			return 0;
		}
		catch (Exception e)
		{
