...
public class Nova_SpriteControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("resizer", get_resizer, set_resizer);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_resizer(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.SpriteController obj = (Nova.SpriteController)o;
			UnityEngine.Transform ret = obj.resizer;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index resizer on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_resizer(IntPtr L)
	{
		object o = null;
