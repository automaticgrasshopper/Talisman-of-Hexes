...
public class Nova_ChoiceImageInformationWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Nova.ChoiceImageInformation), typeof(System.Object));
		L.RegFunction("New", _CreateNova_ChoiceImageInformation);
	...
	static int _CreateNova_ChoiceImageInformation(IntPtr L)
	{
		try
		{
			...
			if (count == 4)
			{
				...
				Nova.ChoiceImageInformation obj = new Nova.ChoiceImageInformation(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Nova.ChoiceImageInformation.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_name(IntPtr L)
	{
		...
		try
		{
			...
			Nova.ChoiceImageInformation obj = (Nova.ChoiceImageInformation)o;
			string ret = obj.name;
